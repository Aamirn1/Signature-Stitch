...
export const products: Product[] = [
  {
    ...
    images: [collectionWC, collectionSK, collection3P],
  ...
  },
  {
    ...
    images: [collectionSK, collectionWC, collectionPants],
  ...
  },
  {
    ...
    images: [collection3P, collectionWC, collectionSK],
  ...
  },
  {
    ...
    category: "Shalwar Kameez",
    categorySlug: "shalwar-kameez",
    images: [collectionSK, collection3P, collectionPants],
