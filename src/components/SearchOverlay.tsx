        ...
        <>
          ...
          >
            <div className="max-w-3xl mx-auto p-4 sm:p-6">
              <div className="flex items-center gap-3 border border-primary/40 rounded-full px-4 py-2 shadow-[0_0_15px_hsl(var(--primary)/0.15)] transition-shadow focus-within:shadow-[0_0_20px_hsl(var(--primary)/0.3)]">
